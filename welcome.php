...
if (isset($_GET['code'])) {
    ...
    // Check if the email domain is @student.pnm.edu.ph
    $email_domain = substr(strrchr($userinfo['email'], "@"), 1);
    if ($email_domain !== 'student.pnm.edu.ph') {
        // Redirect to an error page or display an error message
        echo "Access denied: Unauthorized domain.";
        die();
    }
